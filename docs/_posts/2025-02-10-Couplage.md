...
La force d’intégration représente la connaissance que partage deux modules, et donc une dépendance entre eux. 
...
Une dernière notion a son important. 
...
On gagnera à s’améliorer en refactoring, en architecture logicielle (et notamment en s’intéressant là l’architecture hexagonale). 
